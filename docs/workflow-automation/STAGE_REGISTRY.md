...
| AUTO-003 | Deterministic repository and validation skills | Engine implementation session | IN_PROGRESS | `feature/auto-003-repository-validation-skills` | `stage-prompts/AUTO-003.md` |
