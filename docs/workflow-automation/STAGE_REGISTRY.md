...
| AUTO-008 | Engine CI baseline: packaging, type-checking, and verified blocker fixes | Engine implementation session | AUTHORIZED | `feature/auto-008-engine-ci-baseline` | `stage-prompts/AUTO-008.md` |
