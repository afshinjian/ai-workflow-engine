...
| AUTO-009 | WorkflowService boundary and read-only `workflowctl auto` surface | Engine implementation session | IN_PROGRESS | `feature/auto-009-workflow-service` | (none — authorized directly by written Human Owner directive; no stage contract file was issued) |
