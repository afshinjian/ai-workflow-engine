...
| AUTO-005 | PMO, implementation, QA, Git, merge, and closeout agents | Engine implementation session | IN_PROGRESS | `feature/auto-005-agents` | `stage-prompts/AUTO-005.md` |
