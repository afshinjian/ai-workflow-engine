...
| DASH-006 | Git, upstream, handover, consistency views | Dashboard implementation session | AUTHORIZED | `feature/dash-006-git-handover-views` | `stage-prompts/DASH-006.md` |
